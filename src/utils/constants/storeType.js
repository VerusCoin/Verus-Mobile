...
export const INIT_DLIGHT_CHANNEL = 'INIT_DLIGHT_CHANNEL';
export const START_DLIGHT_SYNC = 'START_DLIGHT_SYNC';
export const STOP_DLIGHT_SYNC = 'STOP_DLIGHT_SYNC';

// Electrum
export const INIT_ELECTRUM_CHANNEL = 'INIT_ELECTRUM_CHANNEL';

// Eth
export const INIT_ETH_CHANNEL = 'INIT_ETH_CHANNEL';

// ERC20
export const INIT_ERC20_CHANNEL = 'INIT_ERC20_CHANNEL';
