...
export const RELEASE_COIN_API_CALL = 'RELEASE_COIN_API_CALL';
export const RELEASE_SERVICE_API_CALL = 'RELEASE_SERVICE_API_CALL';
export const SESSION_REQUEST_STARTED = 'SESSION_REQUEST_STARTED';
