...
export const SET_VERUSID_NOTIFICATIONS = 'SET_VERUSID_NOTIFICATIONS';
...
// Valu Service Channel
export const INIT_VALU_COIN_CHANNEL_START = 'INIT_VALU_COIN_CHANNEL_START';
export const INIT_VALU_COIN_CHANNEL_FINISH = 'INIT_VALU_COIN_CHANNEL_FINISH';
export const INIT_VALU_SERVICE_CHANNEL_START = 'INIT_VALU_SERVICE_CHANNEL_START';
export const OPEN_VALU_SERVICE_CHANNEL = 'OPEN_VALU_SERVICE_CHANNEL';
export const CLOSE_VALU_COIN_CHANNEL = 'CLOSE_VALU_COIN_CHANNEL';
export const AUTHENTICATE_VALU_SERVICE = 'AUTHENTICATE_VALU_SERVICE';
export const DEAUTHENTICATE_VALU_SERVICE = 'DEAUTHENTICATE_VALU_SERVICE';
export const SET_VALU_ACCOUNT_ID = 'SET_VALU_ACCOUNT_ID';
export const SET_CURRENT_VALU_ACCOUNT_DATA = 'SET_CURRENT_VALU_ACCOUNT_DATA';
export const CLOSE_VALU_SERVICE_CHANNEL = 'CLOSE_VALU_SERVICE_CHANNEL';
export const SET_VALU_ACCOUNT_STAGE = 'SET_VALU_ACCOUNT_STAGE';
export const SET_VALU_AMOUNT_FUNDED = 'SET_VALU_AMOUNT_FUNDED';
