...
export const coinsList = {
  ...
  iSojYsotVzXz4wh2eJriASGo6UidJDDhL2: {
    testnet: true,
    pbaas_options: 545,
    id: "iSojYsotVzXz4wh2eJriASGo6UidJDDhL2",
    currency_id: "iSojYsotVzXz4wh2eJriASGo6UidJDDhL2",
    system_id: "iJhCezBExJHvtyH3fGhNnt2NhU4Ztkf2yq",
    bitgojs_network_key: 'verustest',
  ...
  iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm: {
    testnet: true,
    pbaas_options: 136,
    id: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm",
    currency_id: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm",
    system_id: "iJhCezBExJHvtyH3fGhNnt2NhU4Ztkf2yq",
    bitgojs_network_key: 'verustest',
    display_ticker: 'vETH',
    display_name: 'vETH',
  ...
  iN9vbHXexEh6GTZ45fRoJGKTQThfbgUwMh: {
    testnet: true,
    pbaas_options: 32,
    id: "iN9vbHXexEh6GTZ45fRoJGKTQThfbgUwMh",
    currency_id: "iN9vbHXexEh6GTZ45fRoJGKTQThfbgUwMh",
    system_id: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm",
    bitgojs_network_key: 'verustest',
    display_ticker: 'DAI.vETH',
    display_name: 'DAI.vETH',
    alt_names: [],
    theme_color: '#232323',
    compatible_channels: [VERUSID, VRPC],
    tags: [IS_VERUS, IS_ZCASH, IS_PBAAS],
