...
import {EncryptLocally, MyProfile, MyWalletLight, VerusLogo} from '../../../images/customIcons';
...
export default function WelcomeSlider(props) {
  ...
  return (
    <SafeAreaView
      ...
      <AppIntroSlider
        showSkipButton={true}
        renderItem={({item, index}) => renderSlide(index, item.graphic, item.text, item.title)}
        bottomButton={true}
