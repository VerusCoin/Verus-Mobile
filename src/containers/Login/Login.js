...
import {Button, Checkbox, Portal, TextInput} from 'react-native-paper';
          ...
          <ScrollView
            ...
            <Portal>
              {this.state.accountSelectModalOpen && (
                <ListSelectionModal
                  ...
                  cancel={() => this.setState({accountSelectModalOpen: false})}
                />
              )}
            </Portal>
            <NewLogoComponent />
            <TouchableOpacity
              ...
              <TextInput
                ...
                dense
                value={this.state.selectedAccount.id}
                editable={false}
                pointerEvents="none"
                style={{
            ...
            <View
              ...
              <Checkbox.Item
                ...
                label={'Make default'}
                status={this.state.makeDefaultAccount ? 'checked' : 'unchecked'}
                onPress={() =>
                  this.setState({
                    makeDefaultAccount: !this.state.makeDefaultAccount,
                  })
                }
                mode="android"
              />
