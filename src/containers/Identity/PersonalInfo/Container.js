...
import {
  selectClaimCategoriesToDisplay, selectShowEmptyClaimCategories, selectCountClaimsByCategory, selectClaims,
...
const mapStateToProps = (state) => ({
  ...
  claimsCountByCategory: selectCountClaimsByCategory(state),
});
