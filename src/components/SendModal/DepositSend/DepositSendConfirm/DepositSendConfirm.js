...
import { DepositSendConfirmRender } from "./DepositSendConfirm.render"

class DepositSendConfirm extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.setState({
      confirmationFields: [
        ...
        {
          key: "Source",
          data: this.state.source.displayName,
        },
        {
          key: "Destination",
          data: toAddress,
  ...
  render() {
    return DepositSendConfirmRender.call(this);
  }
}
...
export default connect(mapStateToProps)(DepositSendConfirm);